      ...
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/70">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-800">Favicon &amp; Brand Icon Selector</h2>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          <div className="bg-slate-900 rounded-xl p-4 text-white space-y-3 shadow-inner">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
              ...
              <div className="bg-slate-200 rounded-lg p-2 flex flex-col gap-1.5">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <h3 className="text-xs font-bold uppercase tracking-wider text-slate-700 flex items-center gap-1.5">
                <Layers className="w-3.5 h-3.5 text-indigo-600" /> Curated Modern Generated Favicons (6 Styles)
              </h3>
              <span className="text-xs text-slate-500">Click any card to preview</span>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {FAVICON_COLLECTION.map((item) => {
                ...
                return (
                  ...
                  >
                    {isSelected && (
                      <div className="absolute top-2 right-2 w-5 h-5 bg-indigo-600 rounded-full flex items-center justify-center text-white shadow-xs">
                        <Check className="w-3 h-3" />
                      </div>
                    )}
                    <div className="w-14 h-14 p-1 rounded-xl bg-slate-900/5 flex items-center justify-center">
                      <img
          ...
          <div className="border border-dashed border-slate-300 rounded-xl p-4 bg-slate-50/50 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-indigo-100 text-indigo-700 flex items-center justify-center shrink-0">
                <Upload className="w-5 h-5" />
              </div>
              <div>
                <h4 className="text-xs font-bold text-slate-800">Upload Your Custom Favicon</h4>
            ...
            <div className="flex items-center gap-2">
              <label className="bg-white border border-slate-200 hover:border-slate-300 text-slate-700 px-3.5 py-1.5 rounded-lg text-xs font-semibold cursor-pointer shadow-xs transition hover:bg-slate-50 flex items-center gap-1.5">
        ...
        <div className="px-6 py-4 border-t border-slate-100 bg-slate-50 flex items-center justify-between gap-3">
          <button
            ...
            className="text-xs font-medium text-slate-500 hover:text-slate-700 flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2.5">
            <button
              ...
              className="px-3.5 py-2 border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 rounded-lg text-xs font-medium transition shadow-xs flex items-center gap-1.5 cursor-pointer"
            >
