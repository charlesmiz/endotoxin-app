  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 dark:bg-slate-950/80 backdrop-blur-xs animate-in fade-in duration-150">
      <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="px-6 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center gap-2 overflow-x-auto text-xs font-medium shrink-0 py-2">
          <button
        ...
        <div className="p-6 overflow-y-auto flex-1 text-slate-700 dark:text-slate-300 text-xs leading-relaxed space-y-6">
          {activeSection === 'overview' && (
            <div className="space-y-4">
              <div className="bg-indigo-50/70 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900/60 rounded-xl p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl p-4 shadow-xs space-y-2">
                  ...
                  <div className="text-[11px] bg-slate-50 dark:bg-slate-850 p-2 rounded border border-slate-200 dark:border-slate-700 font-mono text-slate-700 dark:text-slate-300">
              ...
              <div className="border border-emerald-200 dark:border-emerald-800/80 bg-emerald-50/60 dark:bg-emerald-950/40 rounded-xl p-4 text-emerald-950 dark:text-emerald-200 space-y-1">
                <div className="font-bold flex items-center gap-1.5 text-emerald-800 dark:text-emerald-300">
                  <GitCompare className="w-4 h-4 text-emerald-700 dark:text-emerald-400" />
          ...
          {activeSection === 'sop' && (
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3.5 bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl">
                  <div className="w-6 h-6 rounded-full bg-indigo-600 dark:bg-indigo-500 text-white font-bold flex items-center justify-center shrink-0 text-xs">
                    1
                  </div>
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs">Establish Coagulation Standard Curve</h4>
                ...
                <div className="flex items-start gap-3 p-3.5 bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs">Quantify Unknown Samples (Coagulation)</h4>
                    <p className="text-slate-600 dark:text-slate-400 mt-0.5">
                ...
                <div className="flex items-start gap-3 p-3.5 bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs">Perform Phenoloxidase Kinetic Assay</h4>
                    <p className="text-slate-600 dark:text-slate-400 mt-0.5">
                ...
                <div className="flex items-start gap-3 p-3.5 bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs">Cross-Assay Concordance Comparison</h4>
                    <p className="text-slate-600 dark:text-slate-400 mt-0.5">
                ...
                <div className="flex items-start gap-3 p-3.5 bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs">Generate Validation Report &amp; Dossier</h4>
                    <p className="text-slate-600 dark:text-slate-400 mt-0.5">
          ...
          {activeSection === 'po_modes' && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="border border-indigo-200 dark:border-indigo-800/80 rounded-xl p-4 bg-indigo-50/40 dark:bg-indigo-950/40 space-y-2">
                  <span className="px-2 py-0.5 bg-indigo-600 dark:bg-indigo-500 text-white text-[10px] font-bold rounded uppercase">
                    Mode A: Pre-calculated Direct Rates
                  </span>
                  <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs">Single Velocity (&Delta;A / min)</h4>
                  <p className="text-slate-600 dark:text-slate-400">
                ...
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-4 bg-white dark:bg-slate-800/80 space-y-2 shadow-xs">
                  <span className="px-2 py-0.5 bg-slate-700 dark:bg-slate-600 text-white text-[10px] font-bold rounded uppercase">
                    Mode B: Raw Time-Series Absorbance Matrix
                  </span>
                  <h4 className="font-bold text-slate-900 dark:text-slate-100 text-xs">Multi-Point Progress Curves</h4>
                  <p className="text-slate-600 dark:text-slate-400">
          ...
          {activeSection === 'anova' && (
            <div className="space-y-4">
              ...
              <div className="bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl p-4 space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-3 bg-white dark:bg-slate-800/80 space-y-1">
                  <div className="font-bold text-slate-900 dark:text-slate-100 text-xs">1. Regression Sum of Squares (SS_Reg)</div>
                  <p className="text-slate-600 dark:text-slate-400 text-[11px]">
                    Measures the variance in absorbance directly accounted for by changes in endotoxin concentration.
                  </p>
                </div>
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-3 bg-white dark:bg-slate-800/80 space-y-1">
                  <div className="font-bold text-slate-900 dark:text-slate-100 text-xs">2. Residual Error (SS_Res)</div>
                  <p className="text-slate-600 dark:text-slate-400 text-[11px]">
                    Measures unexplained background experimental noise and instrument measurement error.
                  </p>
                </div>
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-3 bg-white dark:bg-slate-800/80 space-y-1">
                  <div className="font-bold text-slate-900 dark:text-slate-100 text-xs">3. F-Statistic &amp; p-Value</div>
                  <p className="text-slate-600 dark:text-slate-400 text-[11px]">
          ...
          {activeSection === 'statuses' && (
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-3.5 bg-white dark:bg-slate-800/80 space-y-2">
                  <h4 className="font-bold text-indigo-900 dark:text-indigo-300 text-xs uppercase tracking-wide">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    ...
                    <div className="p-2 rounded-lg bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 text-[11px]">
                      <span className="font-bold text-amber-800 dark:text-amber-300">Extrapolated:</span>
                      <p className="text-amber-700 dark:text-amber-400 mt-0.5">
                        Absorbance is outside the standard curve calibration range. Dilution is recommended.
                      </p>
                    </div>
                    <div className="p-2 rounded-lg bg-slate-50 dark:bg-slate-850 border border-slate-200 dark:border-slate-700 text-[11px]">
                      <span className="font-bold text-slate-800 dark:text-slate-200">Clamped Negative:</span>
                      <p className="text-slate-600 dark:text-slate-400 mt-0.5">
                ...
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-3.5 bg-white dark:bg-slate-800/80 space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <div className="p-2 rounded-lg bg-slate-100 dark:bg-slate-850 border border-slate-200 dark:border-slate-700 text-[11px]">
                      <span className="font-bold text-slate-800 dark:text-slate-200">Baseline (&lt; 0.001 OD/min):</span>
                      <p className="text-slate-600 dark:text-slate-400 mt-0.5">
                        Minimal substrate turnover. Characterizes sterile pyrogen-free negative control samples.
                      </p>
                    </div>
                    <div className="p-2 rounded-lg bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-800 text-[11px]">
                      <span className="font-bold text-indigo-800 dark:text-indigo-300">Active PO (0.001 - 0.010 OD/min):</span>
                    ...
                    <div className="p-2 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-[11px]">
                      <span className="font-bold text-emerald-800 dark:text-emerald-300">High Velocity (≥ 0.010 OD/min):</span>
                      <p className="text-emerald-700 dark:text-emerald-400 mt-0.5">
                ...
                <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-3.5 bg-white dark:bg-slate-800/80 space-y-2">
                  <h4 className="font-bold text-emerald-900 dark:text-emerald-300 text-xs uppercase tracking-wide">
                    Cross-Assay Concordance (RPD %)
                  </h4>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    <div className="p-2 rounded-lg bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200 dark:border-emerald-800 text-[11px]">
                      <span className="font-bold text-emerald-800 dark:text-emerald-300">High Concordance (RPD ≤ 15%):</span>
                      <p className="text-emerald-700 dark:text-emerald-400 mt-0.5">
                        Both clotting and enzyme velocity pathways independently confirm identical endotoxin quantification.
                      </p>
                    </div>
                    <div className="p-2 rounded-lg bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 text-[11px]">
                      <span className="font-bold text-blue-800 dark:text-blue-300">Moderate (15% &lt; RPD ≤ 30%):</span>
                      <p className="text-blue-700 dark:text-blue-400 mt-0.5">
                        Within standard biological assay variation for invertebrate hemolymph.
                      </p>
                    </div>
                    <div className="p-2 rounded-lg bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-800 text-[11px]">
                      <span className="font-bold text-rose-800 dark:text-rose-300">Discordant (RPD &gt; 30%):</span>
                      <p className="text-rose-700 dark:text-rose-400 mt-0.5">
          ...
          {activeSection === 'faq' && (
            <div className="space-y-3">
              ...
              <div className="border border-slate-200 dark:border-slate-700 rounded-xl p-3.5 bg-white dark:bg-slate-800/80 space-y-1">
        ...
        {/* Modal Footer */}
        <div className="px-6 py-3.5 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-850 flex items-center justify-between shrink-0">
